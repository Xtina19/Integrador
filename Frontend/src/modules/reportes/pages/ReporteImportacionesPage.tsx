...
import { shipments, shipmentStatusMap } from '@/mocks/mockImportaciones'
import { useTableExport } from '@/hooks/useTableExport'

export function ReporteImportacionesPage() {
  const { onExportPdf, onExportExcel } = useTableExport('Reporte Importaciones')
      ...
      <Card>
        <CardBody>
          <Toolbar
            ...
            onExportExcel={() =>
              onExportExcel(
                ['Embarque', 'Tipo', 'Origen', 'Destino', 'Salida', 'Llegada', 'Cajas', 'Estado'],
                filtered.map((s) => [
                  s.code,
                  s.type,
                  s.origin,
