...
const pageTitles: Record<string, { title: string; subtitle: string }> = {
  ...
  '/ventas': { title: 'Ventas', subtitle: '' },
  '/ventas/pos': { title: 'Punto de Venta', subtitle: '' },
  '/ventas/facturas': { title: 'Facturas', subtitle: '' },
  '/ventas/notas-credito': { title: 'Notas de Crédito', subtitle: 'Consulta administrativa' },
  '/ventas/historial': { title: 'Ventas', subtitle: '' },
  '/ventas/cambios-notas': { title: 'Notas de Crédito', subtitle: '' },
  ...
  '/configuracion/monedas': { title: 'Monedas', subtitle: 'Monedas habilitadas en el sistema' },
  ...
  '/administracion/clientes': { title: 'Clientes', subtitle: 'Catálogo maestro de clientes' },
  '/administracion/clientes/alta-rapida': { title: 'Alta rápida de cliente', subtitle: 'Registro desde punto de venta' },
...
const prefixTitles: { prefix: string; title: string; subtitle: string }[] = [
  { prefix: '/ventas/facturas/', title: 'Factura', subtitle: '' },
