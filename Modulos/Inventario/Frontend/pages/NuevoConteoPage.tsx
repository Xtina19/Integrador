  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <FormBreadcrumb
          items={[
            ...
            { label: 'Conteos', to: '/inventario?tab=movimientos&filtro=conteos' },
        ...
        <Button
          ...
          size="sm"
          icon={ArrowLeft}
          onClick={() => navigate('/inventario?tab=movimientos&filtro=conteos')}
        >
          Regresar
        </Button>
      </div>
      ...
      <div className="flex flex-col items-stretch justify-end gap-3 border-t border-gray-200 pt-2 sm:flex-row sm:items-center">
        <Button variant="outline" onClick={() => navigate('/inventario?tab=movimientos&filtro=conteos')}>
          Cancelar
        </Button>
        <Button
          icon={Save}
