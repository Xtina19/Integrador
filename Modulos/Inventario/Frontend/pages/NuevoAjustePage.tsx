...
export function NuevoAjustePage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      navigate('/inventario?tab=movimientos&filtro=ajustes')
    } catch (e) {
  ...
  return (
    <DetailPageShell
      breadcrumbs={[
        ...
        { label: 'Ajustes', to: '/inventario?tab=movimientos&filtro=ajustes' },
        { label: 'Nuevo ajuste' },
      ]}
      backPath="/inventario?tab=movimientos&filtro=ajustes"
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-stretch justify-end gap-3 border-t border-gray-200 pt-2 sm:flex-row sm:items-center">
          <Button variant="outline" onClick={() => navigate('/inventario?tab=movimientos&filtro=ajustes')}>
            Cancelar
          </Button>
