...
export function NuevoDescartePage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      navigate('/inventario?tab=movimientos&filtro=descartes')
    } catch (e) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <FormBreadcrumb
          items={[
            ...
            { label: 'Descartes', to: '/inventario?tab=movimientos&filtro=descartes' },
        ...
        <Button
          ...
          size="sm"
          icon={ArrowLeft}
          onClick={() => navigate('/inventario?tab=movimientos&filtro=descartes')}
        >
          Regresar
        </Button>
      </div>
      ...
      <div className="flex flex-col items-stretch justify-end gap-3 border-t border-gray-200 pt-2 sm:flex-row sm:items-center">
        <Button variant="outline" onClick={() => navigate('/inventario?tab=movimientos&filtro=descartes')}>
          Cancelar
        </Button>
        <Button
          icon={Save}
