...
export const events = [
  ...
  { id: 'EV-03', name: 'Feria del Libro Guadalajara', type: 'feria', startDate: '2026-11-28', endDate: '2026-12-06', location: 'Expo Guadalajara', status: 'planned', participants: 8, reservations: 0 },
  { id: 'EV-04', name: 'Club de lectura mensual', type: 'evento', startDate: '2026-06-20', endDate: '2026-06-20', location: 'Sucursal Polanco', status: 'upcoming', participants: 3, reservations: 35 },
]
