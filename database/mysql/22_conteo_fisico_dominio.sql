...
-- Reemplazado por database/mysql/inventario_definitivo/ (ver 01_cleanup_
-- redundante.sql + 06_conteos.sql). NO ejecutar este archivo junto al paquete
-- definitivo: 01_cleanup_redundante.sql hace DROP de las tablas que este
-- script crea (conteo_alcance_producto, snapshot_conteo, linea_conteo,
-- auditoria_conteo_fisico) y 06_conteos.sql las recrea con estados/columnas
-- alineados al agregado ConteoFisico.ts. Se conserva únicamente como
-- referencia histórica; copia intacta en database/mysql/archive/.
-- =============================================================================
