...
-- Reemplazado por database/mysql/inventario_definitivo/12_vistas_indices.sql
-- (v_inv_existencias, v_inv_kardex, v_inv_auditoria, v_inv_transferencias_
-- activas, v_inv_conteos_abiertos, v_inv_ajustes_pendientes, v_inv_descartes_
-- pendientes, v_inv_dashboard_kpis + alias v_inventario_existencias /
-- v_kardex_documento / v_auditoria_inventario). NO ejecutar junto al paquete
-- definitivo para evitar vistas duplicadas con semántica distinta. Se
