...
-- redundante.sql + 07_descartes.sql). NO ejecutar junto al paquete
-- definitivo: 01_cleanup_redundante.sql hace DROP de `descarte`,
-- `descarte_detalle`, `descarte_evidencia`, `descarte_aprobacion` y
-- 07_descartes.sql las recrea con estados/columnas alineados al agregado
-- Descarte.ts. Se conserva únicamente como referencia histórica; copia
-- intacta en database/mysql/archive/.
-- =============================================================================
